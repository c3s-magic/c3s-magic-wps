        ...
        inputs = [
            *model_experiment_ensemble(start_end_year=(1850, 2005), start_end_defaults=(1997, 1997)),
            ...
            LiteralInput(
                'target_grid',
                'Target Grid',
                abstract='in degrees (e.g. \'1x1\') can also be the name of one of the dhttp://node031:5000/wps
atasets to use the grid from that dataset',
                data_type='string',
                default='1x1',
            ),
            LiteralInput(
